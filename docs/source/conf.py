...
texinfo_documents = [('index', 'paullaircbot', u'paulla.ircbot Documentation',
                     u'Michael Ricart', 'paullaircbot', 'One line description of project.',
                     'Miscellaneous'), ]
...
epub_title = u'paulla.ircbot'
epub_author = u'Michael Ricart'
epub_publisher = u'Michael Ricart'
epub_copyright = u'2014, Michael Ricart'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'paulla.ircbot'
